...
const HelperAvailabilityCalendar: React.FC<HelperAvailabilityCalendarProps> = ({
  ...
  const loadAvailability = async () => {
    ...
    try {
      ...
      // Generate sample availability if no data
      if (!data || data.length === 0) {
        ...
        for (let i = 0; i < 30; i++) {
          ...
          // Add morning, afternoon, and evening slots
          ...
          timeSlots.forEach(time => {
            ...
            availabilityMap[dateStr].push({
              ...
              time,
              duration: 2,
              isAvailable: !isWeekend && randomAvailable,
              isBooked: !randomAvailable && Math.random() > 0.5
            });
          });
        }
      } else {
