  ...
  async createSurveyEntry(entry: any) {
    try {
      ...
      const mappedEntry = {
        ...
        activity_categories: entry.activity_categories,
        ...
        people_challenges: entry.people_challenges,
        ...
        event_stress_rating: entry.event_stress_rating,
        mbp_memory: entry.mbp_memory,
        mbp_behavior: entry.mbp_behavior,
        mbp_depression: entry.mbp_depression,
        mbp_distress: entry.mbp_distress,
        affect_cheerful: entry.affect_cheerful,
        affect_relaxed: entry.affect_relaxed,
        affect_enthusiastic: entry.affect_enthusiastic,
        affect_satisfied: entry.affect_satisfied,
        affect_insecure: entry.affect_insecure,
        affect_lonely: entry.affect_lonely,
        affect_anxious: entry.affect_anxious,
        affect_irritated: entry.affect_irritated,
        affect_down: entry.affect_down,
        affect_desperate: entry.affect_desperate,
        affect_tensed: entry.affect_tensed,
        ...
        task_difficulty: entry.task_difficulty,
        resources_using: entry.resources_using,
        resources_wanted: entry.resources_wanted,
        daily_soc_stressed: entry.daily_soc_stressed,
        daily_soc_privacy: entry.daily_soc_privacy,
        daily_soc_strained: entry.daily_soc_strained,
        daily_burden_rating: entry.daily_burden_rating,
  ...
  async updateSurveyEntry(id: number, updates: any) {
    try {
      ...
      const mappedUpdates = {
        ...
        activity_categories: updates.activity_categories,
        ...
        people_challenges: updates.people_challenges,
        ...
        event_stress_rating: updates.event_stress_rating,
        mbp_memory: updates.mbp_memory,
        mbp_behavior: updates.mbp_behavior,
        mbp_depression: updates.mbp_depression,
        mbp_distress: updates.mbp_distress,
        affect_cheerful: updates.affect_cheerful,
        affect_relaxed: updates.affect_relaxed,
        affect_enthusiastic: updates.affect_enthusiastic,
        affect_satisfied: updates.affect_satisfied,
        affect_insecure: updates.affect_insecure,
        affect_lonely: updates.affect_lonely,
        affect_anxious: updates.affect_anxious,
        affect_irritated: updates.affect_irritated,
        affect_down: updates.affect_down,
        affect_desperate: updates.affect_desperate,
        affect_tensed: updates.affect_tensed,
        urgency_level: updates.urgency_level,
        support_needed: updates.support_needed,
        challenge_types: updates.challenge_types,
        challenges_faced: updates.challenges_faced,
        task_difficulty: updates.task_difficulty,
        resources_using: updates.resources_using,
        resources_wanted: updates.resources_wanted,
        daily_soc_stressed: updates.daily_soc_stressed,
        daily_soc_privacy: updates.daily_soc_privacy,
        daily_soc_strained: updates.daily_soc_strained,
        daily_burden_rating: updates.daily_burden_rating,
