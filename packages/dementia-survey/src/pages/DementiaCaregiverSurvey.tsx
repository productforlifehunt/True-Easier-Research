...
const DementiaCaregiverSurvey: React.FC<DementiaCaregiverSurveyProps> = ({ language = 'en' }) => {
  ...
  const handleVoiceInput = (field: 'description' | 'difficulties_challenges' | 'help_reaching_challenges' | 'communication_challenges' | 'collaboration_challenges' | 'knowledge_gaps' | 'liability_concerns' | 'tools_using' | 'tools_wanted' | 'support_needed') => {
    ...
    try {
      ...
      alert('Failed to start voice recording: ' + error);
      setIsRecording(false);
    }
  };
  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: 'var(--bg-primary)' }}>
      ...
      <div className="container mx-auto px-3 py-4 max-w-4xl pb-20">
        ...
        {/* Statistics Panel */}
        {showStats && (
          <div className="bg-white rounded-xl p-4 mb-3 border" style={{ borderColor: 'var(--border-light)' }}>
            <h2 className="text-base font-semibold mb-3 flex items-center" style={{ color: 'var(--text-primary)' }}>
        ...
        {/* Settings Panel */}
        {showSettings && (
          <div className="bg-white rounded-xl p-4 mb-3 border" style={{ borderColor: 'var(--border-light)', overflow: 'visible' }}>
            <h2 className="text-base font-semibold mb-3 flex items-center" style={{ color: 'var(--text-primary)' }}>
        ...
        {showCreateForm && (
          <div className="bg-white rounded-xl p-4 mb-3 border" style={{ borderColor: 'var(--border-light)', overflow: 'visible' }}>
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-1.5 p-1 mb-3 rounded-lg" style={{ backgroundColor: 'var(--bg-secondary)' }}>
              <button
