...
const CreateProjectDialog: React.FC<CreateProjectDialogProps> = ({ 
  ...
  const steps = [
    ...
    { id: 4, name: 'Features', description: 'Enable AI and voice features' }
  ];
        ...
        if (defaultOrg) {
          const { data: newResearcher } = await supabase
            ...
            .insert({
              ...
              first_name: user?.email?.split('@')[0] || 'Researcher',
              last_name: 'User',
              email: user?.email
            })
            .select()
      ...
      if (researcher) {
        ...
        const { data: project, error: projectError } = await supabase
          ...
          .insert({
            ...
            title: projectData.title || 'Untitled Survey',
            ...
            consent_form: projectData.requires_consent ? {
              ...
              text: projectData.consent_text || 'By participating in this study, you agree to provide honest responses. Your data will be kept confidential.'
            } : null,
        ...
        if (projectError) {
          ...
          const defaultQuestions = [
            {
              ...
              required: true,
              order_index: 1,
              options: { scale_type: '1-5', labels: { 1: 'Very Unsatisfied', 5: 'Very Satisfied' } }
            },
            {
              project_id: project.id,
          ...
          if (questions) {
            ...
            if (mcQuestion) {
              const options = [
                { question_id: mcQuestion.id, option_text: 'Dashboard', option_value: 'dashboard' },
                { question_id: mcQuestion.id, option_text: 'Analytics', option_value: 'analytics' },
                { question_id: mcQuestion.id, option_text: 'Reports', option_value: 'reports' },
                { question_id: mcQuestion.id, option_text: 'Settings', option_value: 'settings' },
                { question_id: mcQuestion.id, option_text: 'Collaboration', option_value: 'collaboration' }
              ];
      ...
      <div className="bg-white rounded-2xl p-8 max-w-4xl w-full max-h-[90vh] overflow-y-auto">
                  ...
                  <div>
                    ...
                    <div className="space-y-3">
                      ...
                      <button
                        ...
                        className="text-sm px-4 py-2 rounded-lg border-2 hover:bg-gray-50"
            ...
            <div className="space-y-6">
              <div className="space-y-4">
                <label className="flex items-center gap-3">
                  <input
                    type="checkbox"
                    checked={projectData.ai_enabled}
                    onChange={(e) => setProjectData({ ...projectData, ai_enabled: e.target.checked })}
                    className="w-5 h-5"
                  />
                  <div>
                    ...
                    <p className="text-sm" style={{ color: 'var(--text-secondary)' }}>
                      AI-powered sentiment analysis and smart insights
                    </p>
                  </div>
                </label>
        ...
        <div className="flex justify-between">
          <button
            ...
            className="px-6 py-3 rounded-lg font-semibold border-2 hover:bg-gray-50 disabled:opacity-50 inline-flex items-center gap-2"
