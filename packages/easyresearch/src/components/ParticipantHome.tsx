...
import { FileText, Clock, Trophy, TrendingUp, Plus, Edit, Trash2, Copy, BarChart3 } from 'lucide-react';
                ...
                <div className="pt-4 border-t space-y-2" style={{ borderColor: 'var(--border-light)' }}>
                  <div className="flex items-center gap-2">
                    ...
                    <code className="px-2 py-1 rounded text-sm font-mono" style={{ backgroundColor: '#f0fdf4', color: 'var(--color-green)' }}>
                      {enrollment.research_projects.survey_code || 'N/A'}
                    </code>
                    <button
                      onClick={(e) => {
                        e.stopPropagation();
                        navigator.clipboard.writeText(enrollment.research_projects.survey_code || '');
                      }}
