    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
      <div className="bg-white rounded-2xl p-8 max-w-2xl w-full max-h-[90vh] overflow-y-auto">
          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              <button
                ...
                className="w-full flex items-center justify-center gap-2 px-4 py-3 rounded-xl border-2 hover:bg-gray-50 transition-colors"
        ...
        <div className="flex gap-3 mt-8">
          <button
            onClick={onClose}
            className="flex-1 px-6 py-3 rounded-xl font-medium border-2 hover:bg-gray-50 transition-colors"
