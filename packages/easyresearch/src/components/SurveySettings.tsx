...
import { Zap, Mic, Bell, Calendar, DollarSign, Users, Shield, Clock, Share2, Copy, Check, Link2, X, Settings, FileText, List } from 'lucide-react';
...
const SurveySettings: React.FC<SurveySettingsProps> = ({ project, onUpdateProject }) => {
  ...
  const participantLink = `${window.location.origin}/easyresearch/participant/${project.id || 'new'}`;
    ...
    <div className="bg-white rounded-2xl p-6" style={{ border: '1px solid var(--border-light)' }}>
      ...
      <div className="space-y-8 max-w-3xl">
        ...
        <div className="bg-green-50 rounded-xl p-6" style={{ border: '2px solid var(--color-green)' }}>
          ...
          <div>
            ...
            <button
              ...
              className="flex items-center gap-2 px-6 py-3 rounded-lg font-medium text-white hover:opacity-90 transition-all"
          ...
          <div className="space-y-3">
            <label className="flex items-center gap-3 p-4 rounded-lg border cursor-pointer hover:bg-gray-50"
              ...
              <input
                ...
                onChange={(e) => onUpdateProject({ ...project, ai_enabled: e.target.checked })}
                className="rounded"
              />
              ...
              <div className="flex-1">
                ...
                <p className="text-sm mt-1" style={{ color: 'var(--text-secondary)' }}>
                  Smart suggestions, response analysis, and sentiment tracking
                </p>
              </div>
            </label>
        ...
        <div>
          ...
          <label className="flex items-center gap-3 p-4 rounded-lg border cursor-pointer hover:bg-gray-50 mb-4"
            style={{ borderColor: 'var(--border-light)' }}>
            <input
              type="checkbox"
        ...
        <div>
          ...
          <div className="space-y-4">
            <div>
              ...
              <input
                type="text"
                value={project.consent_form?.title || ''}
                onChange={(e) => onUpdateProject({ 
                  ...project, 
                  consent_form: { ...project.consent_form, title: e.target.value }
                })}
                className="w-full px-4 py-2 rounded-lg border"
                style={{ borderColor: 'var(--border-light)' }}
                placeholder="e.g., Research Study Consent Form"
              />
            </div>
            ...
            <div>
              ...
              <textarea
                value={project.consent_form?.text || ''}
                onChange={(e) => onUpdateProject({ 
                  ...project, 
                  consent_form: { ...project.consent_form, text: e.target.value }
                })}
                className="w-full px-4 py-2 rounded-lg border resize-none"
                style={{ borderColor: 'var(--border-light)' }}
                rows={6}
                placeholder="Enter the full consent form text that participants must agree to"
              />
            </div>
            ...
            <label className="flex items-center gap-3">
              <input
                type="checkbox"
                checked={project.consent_form?.required || false}
                onChange={(e) => onUpdateProject({ 
                  ...project, 
                  consent_form: { ...project.consent_form, required: e.target.checked }
                })}
                className="rounded"
              />
              <span className="text-sm" style={{ color: 'var(--text-primary)' }}>
                Require consent before participation
              </span>
            </label>
          </div>
        </div>
          ...
          <div className="bg-purple-50 rounded-xl p-6" style={{ border: '2px solid var(--color-purple, #9333ea)' }}>
            ...
            <div className="space-y-3">
              ...
              <button
                ...
                className="w-full py-3 rounded-lg border-2 border-dashed hover:bg-gray-50 text-sm font-medium"
