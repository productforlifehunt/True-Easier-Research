    ...
    try {
      ...
      if (profileData) {
        ...
        setFormData({
          ...
          notifications_enabled: updatedProfile.notifications_enabled ?? true,
          email_notifications: updatedProfile.email_notifications ?? true,
          push_notifications: updatedProfile.push_notifications ?? true
        });
      }
    } catch (error) {
    ...
    <div className="min-h-screen pb-24" style={{ backgroundColor: 'var(--bg-primary)' }}>
      <div className="max-w-2xl mx-auto px-4 py-6">
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm" style={{ color: 'var(--text-secondary)' }}>Receive push notifications on mobile</p>
              </div>
              <label className="relative inline-flex items-center cursor-pointer">
                <input
                  type="checkbox"
                ...
                />
                <div className="w-11 h-6 rounded-full peer peer-checked:after:translate-x-full after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:rounded-full after:h-5 after:w-5 after:transition-all" 
                  style={{ backgroundColor: formData.push_notifications && formData.notifications_enabled ? 'var(--color-green)' : 'var(--border-light)' }}>
                </div>
              </label>
            </div>
          </div>
        ...
        <div className="bg-white rounded-2xl p-6 mb-4" style={{ border: '1px solid var(--border-light)' }}>
          ...
          <button
            className="w-full px-4 py-3 rounded-lg text-left hover:opacity-80"
