...
import { FlaskRound, Plus, Trash2, BarChart3, Users, Percent, ArrowRight, CheckCircle, TrendingUp, Shuffle } from 'lucide-react';
      ...
      <div className="flex items-center gap-3">
        <div className="flex items-center gap-1 bg-stone-100 rounded-lg p-0.5 flex-1 overflow-x-auto">
          {experiments.map(exp => (
            ...
            >
              <FlaskRound size={11} className="inline mr-1" />
              {exp.name}
            </button>
          ))}
        </div>
