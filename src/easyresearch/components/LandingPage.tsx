    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative pt-32 sm:pt-40 lg:pt-48 pb-24 lg:pb-36 overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-6 text-center">
          <h1 className="text-5xl sm:text-6xl lg:text-[5rem] font-extrabold leading-[1.05] tracking-[-0.035em] text-stone-950 mb-6">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center mb-6">
            <button
              ...
              className="group inline-flex items-center justify-center gap-2.5 px-7 py-3.5 bg-stone-950 text-white text-[15px] font-medium rounded-xl hover:bg-stone-800 transition-all shadow-lg shadow-stone-950/10"
            >
            ...
            <button
              ...
              className="inline-flex items-center justify-center px-7 py-3.5 text-[15px] font-medium text-stone-500 rounded-xl border border-stone-200 hover:border-stone-300 hover:bg-stone-50 transition-all"
            >
        ...
        <div className="relative max-w-3xl mx-auto px-6 mt-20">
          <div className="rounded-2xl border border-stone-100 bg-stone-50/50 backdrop-blur-sm p-6 sm:p-8">
            ...
            <p className="text-[14px] sm:text-[15px] text-stone-500 leading-relaxed mb-6">
      ...
      <section id="features" className="py-24 lg:py-32">
        <div className="max-w-5xl mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-3xl sm:text-4xl font-bold tracking-[-0.03em] text-stone-950 mb-3">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {features.map((f, i) => (
              <div key={i} className="group rounded-2xl border border-stone-100 p-6 hover:border-stone-200 hover:shadow-sm transition-all bg-white">
      ...
      <section className="py-24 lg:py-32 bg-stone-50/60">
        <div className="max-w-3xl mx-auto px-6">
          <h2 className="text-3xl sm:text-4xl font-bold tracking-[-0.03em] text-stone-950 text-center mb-16">
            {t('landing.howItWorks')}
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            {steps.map((s, i) => (
              <div key={i} className="relative text-center">
                <div className="w-12 h-12 rounded-2xl bg-stone-950 text-white text-[14px] font-bold flex items-center justify-center mx-auto mb-5">
                  {s.n}
                </div>
          ...
          <div className="grid grid-cols-2 lg:grid-cols-3 gap-4">
            {useCases.map((uc, i) => (
              ...
              >
                ...
                <h3 className="text-[14px] font-semibold text-stone-800 mb-1">{t(uc.nameKey)}</h3>
      ...
      <section className="py-24 bg-stone-50/60">
        <div className="max-w-2xl mx-auto px-6 text-center">
          <h2 className="text-3xl sm:text-4xl font-bold tracking-[-0.03em] text-stone-950 mb-4">
            {t('landing.cta.title')}
          </h2>
          ...
          <button
            onClick={() => navigate('/easyresearch/auth')}
            className="group inline-flex items-center gap-2.5 px-8 py-4 bg-stone-950 text-white text-[15px] font-medium rounded-xl hover:bg-stone-800 transition-all shadow-lg shadow-stone-950/10"
          >
