  ...
  return (
    ...
    >
      <div className="flex-1 flex flex-col py-2 overflow-y-auto">
        <nav className="flex-1 px-5 py-2 space-y-0.5">
          {navItems.map((item) => {
        ...
        <div className="px-5 py-3 border-t border-stone-100">
          ...
          <button
            ...
            className="flex items-center gap-3 w-full px-3 py-2 rounded-xl text-[13px] font-medium text-stone-400 hover:text-stone-600 hover:bg-stone-50 transition-colors w-full"
          >
